# Contributing to mtl-video2text
...
1. Check existing [issues](https://github.com/musictechlab/mtl-video2text/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-video2text/discussions)
